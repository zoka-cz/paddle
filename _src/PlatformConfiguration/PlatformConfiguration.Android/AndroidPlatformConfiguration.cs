...
namespace PlatformConfiguration.Android
{
	/// <inheritdoc />
	public class AndroidPlatformConfiguration : IPlatformConfiguration
    {
		/// <summary>Constructor</summary>
		public AndroidPlatformConfiguration(string _app_name, string _version)
		{
		...
		/// <inheritdoc />
		public string										LocalAppFolder => System.IO.Path.Combine(System.Environment.GetFolderPath(Environment.SpecialFolder.Personal), AppName);

		/// <inheritdoc />
		public string										TempAppFolder => System.IO.Path.Combine(System.Environment.GetFolderPath(Environment.SpecialFolder.Personal), AppName);
		...
		/// <inheritdoc />
		public bool											MayControlBrightness { get; } = true;

		/// <inheritdoc />
		public bool											MayScanQRCodes { get; } = true; // ToDo: get from HW options

		/// <summary>Will return whether the platform has possibility to access current location</summary>
		public bool											LocationServiceAvailable { get; } = true;
