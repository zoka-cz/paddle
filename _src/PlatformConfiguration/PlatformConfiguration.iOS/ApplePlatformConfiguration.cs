...
namespace PlatformConfiguration.iOS
{
	public class ApplePlatformConfiguration : IPlatformConfiguration
	{
		public ApplePlatformConfiguration(string _app_name, string _version)
		{
